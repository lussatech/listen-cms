        ...
        <Fragment>
            <div className='w-full min-h-screen p-6'>
                <div className='space-y-6'>
                    <h1 className='font-semibold text-4xl text-black leading-[48px]'>Access Control</h1>
                        ...
                        <div className='space-y-4'>
                            ...
                            <div className='flex gap-x-6 text-xs'>
                                <ul className='flex gap-x-3'>
                                    ...
                                    <li className='font-normal'><Checkbox /> Super Admin</li>
                                    <li className='font-normal'><Checkbox /> Member</li>
